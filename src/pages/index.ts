class IndexPageComponent extends HTMLElement {
    ...
    private render(): void {
      this.innerHTML = `
        <section class="bg-[#0f111a] text-white min-h-screen flex flex-col md:flex-row">
          <!-- Sidebar (sticky only on desktop) -->
          <aside class="w-full md:w-[30%] md:h-screen md:sticky md:top-0 flex flex-col justify-between px-8 pt-20 pb-8 z-10 bg-[#0f111a]">
            <div>
              <h1 class="text-4xl font-bold">Simon Nes</h1>
          ...
          <!-- Scrollbare content -->
          <main class="w-full md:w-[70%] overflow-y-auto px-6 sm:px-10 py-16">
